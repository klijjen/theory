...
Объектно ориентированное программирование (ООП) - это методология программирования, которая берёт за основу программы классы, объекты и их взаимодействие.
...
Инкапсуляция - создание новой сущности на базе уже существующей.
